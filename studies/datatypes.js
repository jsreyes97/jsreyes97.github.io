...
//3. Booleans
/*Booleans tell if something has a value of true or false*/
true,false; 

//4. Arrays
/*An Array is a zero indexed list of datatypes. An array can store any datatype. Arrays are held inside brackets "[]"*/ 
...
console.log(name); // Console cannot log "josh" because it has no meaning.

//8.Null
// Null is a keyword that signifies no value in an object.
var obj = {}; // declaring an object
obj['name'] = null; // making a key and giving it a value of null/undefined.
...
// I can't find -infinity but id assume you do that to someone you hate so there console crashes?
var maxNumber = infinity;
var crashMyComputer = -infinity;
...
//Copy by value makes a copy of just the value of the variable. Copy by reference takes the same collection as the varibale assigned to the original collection and can be maniupulated from either variable.
//Copy by Refrence 
var obj = {};
obj.name = "Joshua";
obj.age = "21"; 
