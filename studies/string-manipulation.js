...
var myString = "Joshua";
console.log(myString.length); // prints "6" to console
...
var str = "Apple, Banana, Kiwi";
console.log(str.substring(2, 1)); // removes "Banana"
...
var string = "hELo";
console.log(string.toUpperCase()); // upper cases string to "HELLO"
console.log(string.toLowerCase()); // lower cases string to "hello"
